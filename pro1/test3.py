# 기본 자료형 : int, float, bool, complex, str
...
t = (1, 2, 3, 4) # tuple 굿성 요소가 하나일 때는, t = (1,)요소 뒤에 콤마(,)를 붙인다. 괄호가 없으면 tuple값이다
t = 1, 2, 3, 4 # 위 아래 문장 둘 다 같은 뜻
# 대괄호[]는 리스트, 중괄호{}는 set, dict, 소괄호()는 튜플
print(t, type(t))
